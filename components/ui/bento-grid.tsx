...
export const BentoGridItem = ({
    ...
    return (
        <div
            className={cn(
                "row-span-1 rounded-2xl shadow-input dark:shadow-none p-4 bg-white/[0.08] border border-white/[0.1] justify-between flex flex-col space-y-4 relative overflow-hidden",
                className
            )}
        >
...
export const BentoFeatureCard = ({
    ...
    return (
        <BentoGridItem
            ...
            className={cn("bg-white/[0.08] border-none p-4 md:p-8", className)}
        />
    );
};
...
export const BentoNumberCard = ({
    ...
    return (
        <div
            className={cn(
                "row-span-1 rounded-2xl shadow-input dark:shadow-none p-3 md:p-6 bg-white/[0.08] justify-center flex flex-col space-y-1 md:space-y-2 relative overflow-hidden text-center items-center",
                className
            )}
        >
            {topLabel && (
